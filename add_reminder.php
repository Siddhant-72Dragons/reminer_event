  ...
  background: #b30000; 
	...
	<body>
		...
		<div class='container mt-4'>
			<div class='row'>
				<div class='col-md-4'>
					<h3 class=' text-center' style="color:#ae943f;;">ADD SSL EXPIRY DETAILS</h3>
					<?php 
						if(isset($_POST["reg"])){
					...
					<!-- <div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control"   name='websitename' placeholder="Website Name" >
						</div>
						<div class="form-group">
							<label>Subject</label>
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
							...
							<input type="text" class="form-control datepicker" name='reminderdate' placeholder="dd-mm-yyyy" >
						</div>
						 <div class="form-group">
							<!-- <label>Email</label>
							<input type="email" class="form-control" name='email' placeholder="Email" required > -->
							<label for="sel1" class="form-label">Reminder Before Date</label>
                               <select  class="form-select w-100 border-0 rounded" style="height:35px" id="sel1" name="days" >
							             <option> ---- </option> 
                                         <option>1</option>
                                         <option>2</option>
                                         <option>3</option>
						 ...
						 <div class="form-group">
							...
							<label for="sel1" class="form-label">Choose The Time Period</label>
                               <select  class="form-select w-100 border-0 rounded" style="height:35px" id="sel1" name="timeperiod" >
							             <option> ---- </option> 
                                         <option>Daily</option>
		...
		<h4 style="color:black;">SELECT NUMBER OF ROWS</h4>
				<div class="form-group"> 	
					...
					<table class='table table-bordered mt-5 table-responsive-md table-sm' >
						<thead>
							<tr>
								<td style="border-color:#ae943f;">S.No</td>
								<td style="border-color:#ae943f;">Website Name</td>
...
function validateForm() {
  var x = document.forms["myForm"]["websitetname"].value;
  if (x == "" || x == null) {
    alert("Websitename must be filled out");
